...
In this document we are identifying a problem of transferring digital credentials (e.g. a digital car key, a digital key to a hotel room) from one device (like smartphone) to another. Today, there is no widely accepted way of transferring digital credentials securely between two devices from different manufacturers. 
