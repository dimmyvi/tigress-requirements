...
- (Req-Data-Integrity) When solution requires multiple data exchanges between Sender and Receiver devices (Req-RoundTrips), no third device shall be allowed to interfere into the transfer until completion of the transfer to preserve integrity of data exchanged.
