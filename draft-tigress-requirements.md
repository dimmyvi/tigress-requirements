...
-  Depending on credential type, Provisioning Entity will not allow for two users to use the same credential / cryptographic keys. Credentials on sender and receiver devices will be different and managed independently.
